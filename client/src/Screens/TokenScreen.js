...
const TokenScreen = () => {
  return (
    ...
    <div className='tokenContainer'>
        ...
        <h1>Add websites to be blocked here</h1>

          <div className='addItems'>
            <input type='text' placeholder='✍Add URL of website...' className='tokenInput'/>
            <i className="fa fa-plus add-btn" title="Block Website"></i>
          </div>
