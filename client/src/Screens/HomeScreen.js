    ...
    <>
      ...
      <div className="home">
          ...
          <div className="carouselBanner">
            ...
            <div className="homeCarousel">
              ...
              <div
                ...
                class="carousel slide carouselStyle anim"
              ...
              >
                ...
                <div class="carousel-inner carousel-inner-color">
                  <div class="carousel-item active">
                    ...
                    <p>
                      “It's Great! Helped me become so much more productive and
                      set an actual time-frame for my work and leisure time!”
                    </p>
                  </div>
                  <div class="carousel-item">
                    ...
                    <p>
                      “Blocksite is the best app to improve your time management
        ...
        <div className="gridHeading">
          ...
          <p>
            Check the features SiteAuthenticator offers to help improve your
            productivity, stay focused, and avoid distractions
          </p>
        </div>
        <div className="gridContainer">
          ...
          <div>
            ...
            <p>
              When you’re tempted to change your settings, you’ll have to enter
              your password
            </p>
          </div>
        </div>
        ...
        <div className="intro">
          <div className="introContent">
            ...
            <p>
              ...
              best time management techniques and still have time to browse your
